...
void AFHPlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Attacking
		EnhancedInputComponent->BindAction(RollingAction, ETriggerEvent::Started, this, &AFHBaseCharacter::Dodge);

		//Healing
		EnhancedInputComponent->BindAction(HealingAction, ETriggerEvent::Started, this, &AFHBaseCharacter::Heal);
	}
